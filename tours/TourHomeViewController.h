...
@interface TourHomeViewController : UIViewController {
    ...
    IBOutlet UIBarButtonItem    *__backButton;
    IBOutlet UIBarButtonItem    *__stopListButton;
    IBOutlet UIBarButtonItem    *__startButton;
    IBOutlet UIBarButtonItem    *__mapButton;
