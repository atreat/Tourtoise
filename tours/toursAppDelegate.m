...
#import "toursAppDelegate.h"
#import "ServerRequest.h"


@implementation toursAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    mytoursViewController = [[MyToursViewController alloc] initWithNibName:@"MyToursViewController" bundle:nil];
